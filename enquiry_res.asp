...
<%
				...
				vbody=vbody&"<mark><b>Sparkior Media- Interested : </b></mark><br>"
				vbody=vbody&"<hr>"
				vbody=vbody&"<b>Name : </b>"&request("user_name1")&"<br>"
				vbody=vbody&"<b>Email : </b>"&request("user_phone1") & "<br>"
				vbody=vbody&"<hr>"
			
				Dim myMail
				Set myMail=CreateObject("CDO.Message")
				myMail.Subject = "Sparkior Media- Interested"
				...
				response.write "<span class='btn btn-primary btn-md'>Enquiry Sent!</span>"
%>
